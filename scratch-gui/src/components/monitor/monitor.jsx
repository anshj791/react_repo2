...
const getCategoryColor = (theme, category) => {
    ...
    return {
        background: colors[categoryColorMap[category]]?.primary || '#FFFFFF', // Fallback to white
        text: colors.text || '#000000' // Fallback to black
    };
};

const MonitorComponent = props => {
    // Ensure label is valid and create a fallback if needed
    const contextMenuId = `monitor-${props.label || 'default'}`;
